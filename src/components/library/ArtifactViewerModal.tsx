...
import { getArtifact } from '@/lib/api/library'
...
export function ArtifactViewerModal({ isOpen, onClose, artifactId, artifactTitle }: ArtifactViewerModalProps) {
  ...
  const displayTitle = artifactTitle || title || artifactId || ''
